...
public class CameraSource {
    ...
    private static final String TAG = "BaseApp-OpenCameraSource";
        ...
        synchronized (mCameraLock) {
            ...
            if (mProcessingThread != null) {
                try {
                    ...
                    LogMy.d(TAG, "Frame processing thread interrupted on release.");
                }
            ...
            if (mCamera != null) {
                ...
                try {
                    ...
                    LogMy.e(TAG, "Failed to clear camera preview: " + e);
                }
                mCamera.release();
                mCamera = null;
            }
    ...
    public int doZoom(float scale) {
        synchronized (mCameraLock) {
            ...
            if (!parameters.isZoomSupported()) {
                LogMy.w(TAG, "Zoom is not supported on this device");
                return currentZoom;
            }
    ...
    private Camera createCamera() {
        ...
        if (mFocusMode != null) {
            if (parameters.getSupportedFocusModes().contains(
                ...
                LogMy.i(TAG, "Camera focus mode: " + mFocusMode + " is not supported on this device.");
            }
        }
        ...
        if (mFlashMode != null) {
            if (parameters.getSupportedFlashModes().contains(
                ...
                LogMy.i(TAG, "Camera flash mode: " + mFlashMode + " is not supported on this device.");
            }
        }
    ...
    private static List<SizePair> generateValidPreviewSizeList(Camera camera) {
        ...
        if (validPreviewSizes.size() == 0) {
            LogMy.w(TAG, "No preview sizes have a corresponding same-aspect-ratio picture size");
            for (Camera.Size previewSize : supportedPreviewSizes) {
    ...
    private void setRotation(Camera camera, Camera.Parameters parameters, int cameraId) {
        ...
        switch (rotation) {
            ...
            case Surface.ROTATION_270:
                ...
                break;
            default:
                LogMy.e(TAG, "Bad rotation value: " + rotation);
        }
        ...
        public void run() {
            ...
            while (true) {
                synchronized (mLock) {
                    while (mActive && (mPendingFrameData == null)) {
                        try {
                            ...
                            LogMy.d(TAG, "Frame processing loop terminated.");
                            return;
                        }
                    }
                ...
                try {
                    ...
                    LogMy.e(TAG, "Exception thrown from receiver.", t);
                } finally {
